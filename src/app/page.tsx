              ...
              <div className="flex items-center gap-3">
                {compareIds.size >= 2 && (
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-primary-500 to-primary-600 text-white rounded-xl text-sm font-medium hover:shadow-lg hover:shadow-primary-200/50 transition-all"
                  >
